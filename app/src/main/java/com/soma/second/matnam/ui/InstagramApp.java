...
import com.soma.second.matnam.ui.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
	...
	public static String mCallbackUrl = "http://localhost";
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					String profileImageUri = jsonObj.getJSONObject("user").getString("profile_picture");
					
					mSession.storeAccessToken(mAccessToken, id, user, name, profileImageUri);
